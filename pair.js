...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            ...
            password: 'Weed2002' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'DAMON-XMD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of Damon-XMD.
...
🚀 _Thanks for choosing Damon-XMD — Let the automation begin!_ ✨`;
